...
We find a dataset containing 6 smaller datasets. Five of them are large dataframes while a sixth one is a list of dataframes. For a better overview we separate them.
