...
drivermut =  matrix(c("ERBB2","MYCBP", "PARP10", "PIK3CA"), nrow=4, ncol=1) # create matrix with driver mutation names

data_clus_4 = data_clus_3
data_clus_4["Driver mutation"] <- sapply(1:nrow(data_clus_3), function(j){
     if(rownames(data_clus_4)[j] %in% drivermut){
         data_clus_4[j,1] = "driver mutation"
     } else {
         data_clus_4[j,1] = "no driver mutation"
     }
  }) # labeling driver mutations with "driver mutation" in data_clus_3 
