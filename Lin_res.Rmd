...
hist(resid(regressor), main = 'Histogram of residuals',xlab='Standardised Residuals',ylab='Frequency') #plot a histogram of standardised residuals to check the assumption of normality
dev.off() #closing the figure file


pdf(paste0("HomoPlot.pdf")) #save plots as pdf, in working directory "wd"
...
dev.off() #closing the figure file
  ...
  spearmanPlot <- ggplot(data = test_set, aes(x=test_set$Predictor, y=test_set$Prediction)) + 
