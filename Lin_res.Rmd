...
lapply(seq_along(data_regression), check_assumptions1)
...
Residuals',ylab='Frequency') #plot a histogram of standardised residuals to check the assumption of normality
 ...
 spearmanPlot <- ggscatter(test_set, x = test_set$Predictor, y = test_set$Prediction, 
          ...
          cor.coef = TRUE, cor.method = "spearman", #plot observed and predicted values against each other to visualize correlation
          xlab = "Observed CERES score", ylab = "Predicted CERES score")
 
 # says it can´t find y values?! 
