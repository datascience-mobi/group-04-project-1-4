...
# Possible causes in the size of the sample
...
On the other side, for the supervised machine learning process of the regression, sample sizes up to n = 50,000 are reported.(Libbrecht and Noble 2015) 
In general, more data will lead to improved data quality.(Banko and Brill 2001)

# Possible Causes in the Design of Project
