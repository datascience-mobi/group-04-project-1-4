...
```{r warning = FALSE, echo=TRUE, fig.align= "center", fig.cap="_Fig. 1_ Heatmap of all BCCL CERES scores", eval=FALSE}
...
```{r warning=FALSE, fig.align="center", fig.cap="_Fig. 5_ Optimal cluster number k using WSS of all BCCLs combined" } 
...
```{r warning=FALSE, fig.align="center", fig.cap="_Fig. 6_ K means cluster plot"}
...
```{r data visualisation, fig.align = 'center', fig.cap= "_Fig. 7_ Boxplot of CERES and Expression values of selected driver mutations", warning=FALSE}
...
```{r Regression sample distribution, fig.align = 'center', fig.cap="_Fig. 8_ Heatmaps and QQ plots for each driver mutation", warning=FALSE}
...
```{r Multiple Regression function, fig.align = 'center', fig.cap="_Fig.9_ Residual, Homoscedasticity and Spearman correlation plots for each driver mutation", warning=FALSE}
