...
lapply(testData, function(a) paged_table(a)) #look at the data
```
...
testDataSummary <- sapply(1:length(driver_mut), function(a){
...
colnames(testDataSummary) <- driver_mut
...
lapply(SST_Data, function(a) paged_table(a))
```
...
lapply(SST_Data, function(b) paged_table(b)) # have a look at the SSTs
```
