...
```{r Salome, include=FALSE, eval=TRUE}
...
lapply(seq_along(data_regression), function(a){  
  ...
  cormap <- heatmap.2(r, scale = "none", col = col, 
          trace = "none", density.info = "none", dendrogram = c("both"), main = "Correlation of ... and ...")
  return(list(p)) #Muss hier nicht noch r rein oder funktioniert es so?
   })
```
