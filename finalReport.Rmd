...
The last twelve candidates showed different characteristics. A few of them like APC or FANCA were known as tumorsupressor genes and therefore not further involved. Others showed activity only in neuroektodermal tumors and not in breast cancer. Therefore we want to present our top four cancidates for experimental drug research to be:

####TNS3: 
- verified SST in ERBB2 and Parp10. It is suggested to play a role in actin remodeling and associated with 47 tumor diseases[^1].

####BCL9L:
- known to activate beta catenin, one of the main targets of colorectal cancer. A few other suggested functions in tumorigenesis and 65 associated neoplasms are reason enough to investigate therapeutic options[^1]. 

####CREBBP: 
- This transcriptional activator of cAMP responsive genes is a SST of ERBB2. Already known active cell compounds prove the potential research community is giving to this protein. 176 associated tumor dieases and 463 diseases in general are incentive enough to dare a try [^1].
...
After discovering all functions of our SSTs we investigated if there is already research, searching for their therapeutic potential. In our cohort of 67 SSTs only one SSt were already targetable with a drug. While a few of them are not very present in ongoing research, most of the SSTs popped up somewhere in tumor diseases. We looked a bit deeper in their associations and funtions and decided to present four of them: "TNS3", "BCL9L, "CREBBP" and "SLC4A7" as our main outcome to future therapy investigations. Whe are thrilled to see some of them some day in a drug database.
