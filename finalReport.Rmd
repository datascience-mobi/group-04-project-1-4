...
A promising approach is targeting SSTs, which are gene mutations interacting genetically with driver mutations to increase cell viability. # CITATION
...
data_clus_3e["Driver mutation"] <- sapply(1:nrow(data_clus_3), function(j){
  ...
  }) #Labelling driver mutations with "driver mutation" in data_clus_3e 
```
...
```{r Regression sample distribution, fig.align = 'center', fig.cap="Fig. 8 Heatmaps and QQ plots for each driver mutation", warning=FALSE}
