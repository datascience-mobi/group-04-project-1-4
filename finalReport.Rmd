...
@Salome: Please, check whether this is what you wanted to do!
```{r warning=FALSE}
...
All 67 confirmed SSTs were investigated for already existing drugs and disease association. In genera our SSTs revealed a broad spectrum of knowledge, spreading from genes not only associated with any disease to genes with an approved drug available. We classified our SSTs in 3 classes: class 1 containing genes already associated with at least one sort of breast cancer, class 2 consisting of genes with associations at least in any cancer and class 3, genes without connection to cancer. 
The largest group were SSTs of class 1, containing 43 genes followed bei class 2 genes with 20 members. Group was clearly the smallest one with 4, which can be seen as good because we didn't found any genes completely out of the range of research community or bad due to the will to find genes nobody ever recognized before. All of them except for one, "PDGFRA", had no drug on the marked. Just to keep our workload in limits, we proceeded our analysis with all SSTs having associations to more than 40 sort of cancer or showing interesting characteristics. Our goal was to make a recommendation for drug design of 5 SSTs out of all this knowledge.
