...
While in the pase decades breast cancer therapy has already evolved,reducing the age standardized death rate by one third, from 15.10 to  only 10.00 in western europe (GBD 2017), the necessity to find an effective prevention methods remains (Sledge et al. 2014). One promising method is the computerbased approach. Their share of ... and ... is astonishingly large . Excited what the future may bring, this project takes first steps into computer based analysis of genetic interactions.
