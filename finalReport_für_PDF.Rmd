...
```{r ResidHomo, eval=TRUE, echo=FALSE, fig.cap="Residual distribution histograms and Homoscedasticity Plots for all four models", out.width = '100%', fig.align = "center"}
...
```{r Spearman, eval=TRUE, echo=FALSE, fig.cap="Comparing Distribution of predicted and pbserved CERES score by Spearman correlation", out.width = '100%', fig.align = "center"}
