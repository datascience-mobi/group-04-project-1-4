...
View(head(as.data.frame(mutImpact)))
```
...
View(testDataSummary) #Have a look at the distribution of p-values
```
...
View(SST_Data$ERBB2)
View(SST_Data$MYCBP)
View(SST_Data$PARP10)
View(SST_Data$PIK3CA) 
```
...
View(SST_Data$MYCBP)
View(SST_Data$PARP10)
View(SST_Data$PIK3CA) #Have a look at the SSTs
```
...
```{r Regression sample distribution, fig.align = 'center', fig.cap="_Fig. 7_ Heatmaps and QQ plots for each driver mutation", warning=FALSE, eval = FALSE}
...
```{r Hm and QQ, eval=TRUE, echo=FALSE, fig.cap=" _Fig. 7_ Heatmaps and QQ plots of SSTs", out.width = '100%', fig.align = "center"}
