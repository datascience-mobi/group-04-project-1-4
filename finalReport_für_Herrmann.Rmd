...
```{r ResidHomo, eval=TRUE, echo=FALSE, fig.cap="_Fig. 8_ Residual distribution histograms and homoscedasticity plots for all four models", out.width = '100%', fig.align = "center"}
...
```{r Spearman, eval=TRUE, echo=FALSE, fig.cap=" _Fig. 9_ Comparing distribution of predicted and observed CERES scores by Spearman correlation", out.width = '100%', fig.align = "center"}
