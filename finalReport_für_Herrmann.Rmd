...
```{r Spearman, eval=TRUE, echo=FALSE, fig.cap=" _Fig. 10_ Comparing distribution of predicted (blue) and observed (red) CERES scores by Spearman correlation", out.width = '100%', fig.align = "center"}
