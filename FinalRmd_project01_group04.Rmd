...
To begin with possible driver mutations from literature research were selected based on the following three characteristics:
  ...
  3. part of processes/pathways of tumorigenesis
...
km_CERES= kmeans(x = BCCL_kd.ceres_3, centers = 4, nstart = 10) #Performing kmeans clustering
...
```{r warning=FALSE}
data_cluster = as.data.frame(km_CERES$cluster) #Create dataframe of cluster numbers
