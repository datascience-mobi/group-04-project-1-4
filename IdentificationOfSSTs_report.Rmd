...
To gain an overview of general data distribution we first had to extract the breast cancer data from the larger "allDepMapData" - dataset, containing all kinds of tumor diseases. We therefore identified 28 cell lines harvesting breast cancer.
```{r}
