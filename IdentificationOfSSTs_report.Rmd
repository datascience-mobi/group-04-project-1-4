...
I think we definetly need to put all the packages and libraries back in to ensure that the following code works on any device regardless of previous installations. 
# Abstract
(...)
